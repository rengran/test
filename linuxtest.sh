...
mping(){
	printf "min:最低延迟" "avg:平均延迟" "max:最高延迟" "mdev:平均偏差"
	shping "125.64.38.1" "四川电信"
	shping "106.120.243.142" "北京电信"
	shping "211.144.205.58" "上海电信"
	shping "103.254.70.5" "北京联通"
...
go(){
	...
	echo "测试脚本执行完毕！参数aus ;a 测速全球,u 跑分,s带链接分享。"
	echo "日志文件: ${logfile} ；sssvps.com by tiejiang"
	rm -rf linuxtest.sh
}
sp=$1
action=$2
